...
export default function ReporteIngresos() {
  ...
  const kpis = useMemo(() => {
    ...
    const totalPedidos = data.tabla.reduce(
      (acc, r) => acc + r.totalPedidos,
      0
    );
    ...
    return {
      totalPedidos,
      ingresoPromPedido:
        totalPedidos > 0 ? data.kpis.ingresosTotales / totalPedidos : 0,
      ingresoPromDia: data.kpis.ingresosTotales / dias,
    };
  }, [data]);
