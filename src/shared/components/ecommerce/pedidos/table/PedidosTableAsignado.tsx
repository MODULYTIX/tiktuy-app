      ...
      <table className="min-w-full table-fixed text-[12px] bg-white border border-gray30 rounded-md shadow-[var(--shadow-default)]">
        ...
        <thead className="bg-[#E5E7EB]">
          <tr className="text-gray70 font-roboto font-medium">
            <th className="px-2 py-3 text-gray70 text-center first:rounded-tl-md">Fec. Entrega</th>
            ...
            <th className="px-4 py-3 text-gray70 text-center last:rounded-tr-md">Acciones</th>
          </tr>
        </thead>
